...
function Header_icons() {
    return (
        <nav id="navContent" className="fixed bottom-0 bg-teste-zika shadow-xl-up z-30 w-full flex justify-center items-center p-2 gap-8 text-xl font-regular text-black dark:text-white min-[1000px]:hidden">
