...
function Header() {
    return (
        <>
            <header id="headerContent" className="w-full flex justify-center mt-4">
                <nav id="navContent" className="w-full flex justify-center items-center p-2 gap-8 text-xl font-regular bg-blue-400">
