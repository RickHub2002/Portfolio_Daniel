...
function Header() {
    return(
        <header id="headerContent" className="w-full flex justify-center px-30">
            <nav id="navContent" className="flex gap-8 justify-center items-center text-xl font-regular bg-blue-400">
                <a className="hover:cursor-pointer hover:text-2xl ease-in-out duration-200">Home</a>
