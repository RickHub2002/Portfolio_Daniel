...
function Header() {
    return (
        <header id="headerContent" className="w-full flex justify-center items-start p-4 bg-red-500 h-dvh">
            <nav id="navContent" className="w-full flex justify-center items-center p-4 gap-8 text-xl font-regular bg-blue-400">
