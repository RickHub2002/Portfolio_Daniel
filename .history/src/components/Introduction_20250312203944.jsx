...
function Introduction() {
    return (
        <section className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-center lg:gap-15">
            <div className="lg:flex-grow lg:max-w-[50%] max-sm:text-center">
