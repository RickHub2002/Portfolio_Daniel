...
function About_me() {
    return (
        <section className="flex max-[910px]:flex-col gap-10 pb-10 bg-red-500">
            <div className="max-w-[50%] bg-orange-500">
                <h1 className="text-3xl text-black dark:text-white font-bold mb-8 sm:text-4xl md:text-6xl max-[910px]:text-center">Sobre mim</h1>
            ...
            <div className="bg-blue-500 w-full pt-20.25 max-[910px]:pt-30">
