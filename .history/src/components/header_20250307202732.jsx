...
function Header() {
    return (
        <>
            <header id="headerContent" className="w-full flex justify-center border-1 border-red-500 mt-8">
                <nav id="navContent" className="border-1 w-full min-h-10 flex justify-center items-center p-4 gap-8 text-xl font-regular bg-blue-400">
            ...
            <div className="bg-green-500 w-full h-30 px-4">
                <h1>Bradesco</h1>
            </div>
        </>
    )
