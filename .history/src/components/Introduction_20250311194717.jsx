    ...
    return (
        <section className="flex flex-col lg:flex-row items-center justify-center gap-15">
            <div className="lg:flex-grow lg:max-w-[70%]">
                ...
                <button className="bg-[var(--cor-400)] w-40 h-12 hover:bg-inherit hover:border-1 hover:border-[var(--cor-400)] hover:rounded-sm ease-out duration-200 dark:hover:text-white">Download CV</button>
            </div>
            <Profile />
        </section>
    )
