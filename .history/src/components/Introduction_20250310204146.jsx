    ...
    return (
        <section className="flex flex-col lg:flex-row items-center justify-center gap-15">
            <div className="flex-grow max-w-[500px]">
                ...
                <div className="bg-blue-500 max-w-[50%] text-3xl text-black dark:text-white font-bold sm:text-4xl md:text-6xl lg:text-8xl">
                    <h1 className="max-w-[50%]">DESENVOLVEDOR</h1>
