...
function Introduction() {
    return (
        <section>
            <div>
                <h3 className="text-black dark:text-white text-1xl font-semibold md:text-2xl">Olá! Eu sou</h3>
                <h3 className="text-[var(--cor-200)] text-2xl font-semibold md:text-3xl">Daniel Rezes</h3>
